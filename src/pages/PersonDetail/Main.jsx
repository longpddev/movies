          ...
          <div className="xl:w-1/5 w-full lg:w-1/4 mb-8 lg:mb-0">
            ...
            <div className="">
              ...
              <div className="mb-3">
                ...
                <p className="text-md text-gray-600">{data.known_for_department}</p>
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <p className="text-md text-gray-600">{data.gender === 1 ? 'Female' : 'Male'}</p>
              </div>
              <div className="mb-3">
                <p className="text-md font-semibold">Birthdate</p>
                <p className="text-md text-gray-600">{data.birthday} ({moment(data.birthday, "YYYY-MM-DD").fromNow()})</p>
              </div>
              <div className="mb-3">
          ...
          <div className="xl:w-4/5 lg:pl-10 w-full lg:w-3/4">
              ...
              {knownFor.map((item, index)=>(
                  <div className="px-2 max-w-[175px]" key={index}>
                    <img src={getImage(item.poster_path, 200)} alt={item.title} className="w-full rounded-lg mb-2 block" />
                    <p className="text-gray-700 text-sm text-center px-1">{item.title}</p>
                  </div>
              ))}
              </Flickity>
          </div>
