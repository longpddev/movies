      ...
      <Container.Body>
          <Container.Wrap>
                    ...
                    <div className="w-full rounded-lg border border-gray-300 shadow-md overflow-hidden">
                        ...
                        <ul className="my-2">
                            {data?.translations?.map((item, index) => (
                                <li key={index} className="flex justify-between px-3 py-2 hover:bg-gray-300">
                                    <span className="pointer">{item.name}</span>
                                    <span className="px-3 rounded-full bg-gray-200">{item.iso_639_1 + '-' + item.iso_3166_1}</span>
                                </li>
                            ))}
                        </ul>
                    </div>
              ...
              <Container.Main>
                <div>
                    {data?.translations?.map((item, index) => (
                        <div key={index} className="w-full rounded-lg border border-gray-300 shadow-md overflow-hidden mb-7">
                            <div className="bg-gray-100 px-2 py-2">
                                <span>{item.name} </span>
                                <span className="text-gray-400">{item.iso_639_1 + '-' + item.iso_3166_1}</span>
                            </div>
